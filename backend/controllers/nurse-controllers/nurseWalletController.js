...
exports.getWalletBalance = asyncHandler(async (req, res) => {
  ...
  console.log(`🔍 Fetching wallet balance for nurse:`, {
    id,
    nurseObjectId: nurseObjectId.toString(),
  ...
  console.log(`💰 Nurse wallet balance calculated:`, {
    nurseId: nurseObjectId.toString(),
    totalEarnings,
    totalWithdrawals,
    balance,
    availableBalance,
...
exports.getTransactions = asyncHandler(async (req, res) => {
  ...
  console.log(`🔍 Fetching transactions for nurse:`, {
    id,
    nurseObjectId: nurseObjectId.toString(),
    filter,
  });
