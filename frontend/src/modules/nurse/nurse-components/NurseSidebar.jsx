...
const NurseSidebar = ({ isOpen, onClose, navItems = [], onLogout }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar Content */}
      <aside
        className={`fixed inset-y-0 left-0 z-[70] flex w-[260px] flex-col bg-white border-r border-slate-100 shadow-xl transition-transform duration-300 lg:translate-x-0 ${
        ...
        <div className="flex h-20 items-center justify-between px-6 border-b border-slate-50">
          <div className="flex items-center gap-3">
            ...
            <div className="flex flex-col">
              <span className="text-xs font-black text-[#11496c] uppercase tracking-tighter leading-none">Nurse</span>
