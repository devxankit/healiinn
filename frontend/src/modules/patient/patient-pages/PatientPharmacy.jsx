    ...
    <>
        ...
        <button
          ...
          className={`flex w-full items-center justify-between rounded-lg border bg-white/95 backdrop-blur-sm px-2.5 py-1.5 text-xs font-semibold text-slate-700 shadow-sm transition-all ${
            isOpen
              ...
              : 'border-[rgba(17,73,108,0.3)] hover:border-[rgba(17,73,108,0.4)] hover:bg-white hover:shadow-md focus:border-[#11496c] focus:outline-none focus:ring-2'
          }`}
      ...
      {isOpen && (
        <>
          ...
          <div 
            ref={menuRef}
            className="fixed z-[9999] rounded-lg border-2 border-[rgba(17,73,108,0.4)] bg-white shadow-2xl"
            style={{
            ...
            <div className="flex-shrink-0 mt-auto border-t border-slate-200 p-4 sm:p-5">
              ...
              <div className="flex flex-row gap-2">
                ...
                <button
                  type="button"
                  onClick={() => setDetailPharmacyId(null)}
                  className="flex flex-1 items-center justify-center rounded-lg bg-[#11496c] px-3 py-2 sm:px-4 sm:py-2.5 text-xs sm:text-sm font-semibold text-white transition hover:bg-[#0d3a52]"
                >
                  Close
                </button>
              </div>
        ...
        >
          <div className="relative w-full max-w-2xl max-h-[90vh] overflow-y-auto rounded-3xl border border-slate-200 bg-white shadow-2xl">
            ...
            <div className="sticky top-0 z-10 flex items-center justify-between border-b border-slate-200 bg-white px-3 sm:px-6 py-3 sm:py-4">
              <div>
                <h2 className="text-lg sm:text-xl font-bold text-slate-900">Book Medicine</h2>
                <p className="text-xs sm:text-sm text-slate-600">{bookingPharmacy.pharmacyName}</p>
              </div>
              <button
                type="button"
                onClick={() => {
            ...
            <div className="p-3 sm:p-6">
              ...
              {bookingStep === 1 && (
                <div className="space-y-4 sm:space-y-6">
                  {/* Service Type */}
                  <div>
                    <label className="mb-2 sm:mb-3 block text-xs sm:text-sm font-semibold text-slate-700">Service Type</label>
                    <div className="grid grid-cols-2 gap-2 sm:gap-3">
                      ...
                      >
                        ...
                        >
                          <IoBagHandleOutline className="h-4 w-4 sm:h-5 sm:w-5" />
                        </div>
                        <span className="text-xs sm:text-sm font-semibold text-slate-900">In-Pharmacy Pickup</span>
                      </button>
                      <button
                        type="button"
                      ...
                      >
                        ...
                        <span className="text-xs sm:text-sm font-semibold text-slate-900">Home Delivery</span>
                      </button>
                    </div>
                  </div>
              ...
              {bookingStep === 2 && (
                <div className="space-y-3 sm:space-y-4">
                  <div className="text-center">
                    ...
                    <p className="text-xs sm:text-sm text-slate-600">Prescription and details will be shared with the pharmacy</p>
                  </div>
                  ...
                  <div className="rounded-xl sm:rounded-2xl border border-slate-200 bg-white p-3 sm:p-4 shadow-sm">
                    <div className="space-y-2 sm:space-y-3">
                      <div>
                        <h4 className="mb-1 sm:mb-2 text-sm sm:text-base font-semibold text-slate-900">{bookingPharmacy.pharmacyName}</h4>
                        <p className="text-xs sm:text-sm text-slate-600">{formatAddress(bookingPharmacy.address)}</p>
                      </div>

                      <div className="space-y-2 sm:space-y-3 border-t border-slate-200 pt-2 sm:pt-3">
                        <div className="flex items-center justify-between border-b border-slate-100 pb-2 sm:pb-2.5">
                          <span className="text-xs sm:text-sm font-medium text-slate-600">Service Type</span>
              ...
              <div className="flex items-center justify-between gap-2 sm:gap-3">
                {bookingStep > 1 && (
                  <button
                    ...
                    className="rounded-lg border border-slate-200 bg-white px-3 sm:px-4 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-slate-700 transition hover:border-slate-300 hover:bg-slate-50"
                  >
                    Back
                  </button>
                )}
                {bookingStep < 2 ? (
                  <button
                    ...
                    className="ml-auto flex items-center gap-1.5 sm:gap-2 rounded-lg bg-[#11496c] px-4 sm:px-6 py-2 sm:py-2.5 text-xs sm:text-sm font-semibold text-white transition hover:bg-[#0d3a52] disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    Next
