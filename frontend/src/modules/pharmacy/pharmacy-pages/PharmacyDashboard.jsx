    ...
    <section className="space-y-6 pb-4">
        ...
        <div className="relative space-y-4 p-4 sm:p-5">
          <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-lg font-semibold leading-tight text-white">Pharmacy Dashboard</p>
              <p className="text-sm text-white/80">Manage your orders and services.</p>
            </div>
          </header>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="space-y-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-orange-700">Prescriptions</p>
