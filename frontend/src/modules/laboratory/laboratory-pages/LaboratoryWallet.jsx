  ...
  return (
    <section className="flex flex-col gap-4 pb-4">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-slate-600">Manage your laboratory earnings and withdrawals</p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
        {/* Balance Card */}
        <button
          onClick={() => navigate('/laboratory/wallet/balance')}
        ...
        <button
          ...
          className="group relative overflow-hidden rounded-3xl border-2 border-indigo-100/60 bg-gradient-to-br from-indigo-600 via-indigo-500 to-indigo-600 p-6 text-left text-white shadow-xl shadow-indigo-500/30 transition-all active:scale-95 hover:shadow-2xl hover:shadow-indigo-500/40"
        >
          <div className="absolute -right-20 -top-20 h-40 w-40 rounded-full bg-white/10 blur-3xl" />
          <div className="absolute -left-16 bottom-0 h-32 w-32 rounded-full bg-white/5 blur-2xl" />
          <div className="relative">
