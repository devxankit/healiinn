...
const LaboratoryDashboard = () => {
  ...
  return (
    <section className="space-y-6 pb-4">
      {/* Welcome Section */}
      <section className="relative overflow-hidden rounded-3xl border border-purple-100/70 bg-gradient-to-br from-purple-400/85 via-purple-300/85 to-indigo-400/80 text-slate-900 shadow-lg shadow-purple-300/60 backdrop-blur-xl">
        ...
        <div className="absolute -left-24 bottom-6 h-40 w-40 rounded-full bg-purple-500/40 blur-3xl" />
        ...
        <div className="relative space-y-4 p-4 sm:p-5">
          <header className="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between">
            <div className="space-y-1">
              ...
              <p className="text-sm text-white/80">Manage your test orders and reports.</p>
            </div>
          </header>
        </div>
      </section>
      ...
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3">
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="space-y-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-emerald-700">Total Orders</p>
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="space-y-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-blue-700">Active Patients</p>
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="space-y-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-orange-700">Test Reports</p>
        ...
        >
          ...
          <div className="relative flex items-center justify-between">
            <div className="space-y-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-purple-700">Notifications</p>
